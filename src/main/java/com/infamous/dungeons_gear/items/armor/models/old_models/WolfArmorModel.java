...
@OnlyIn(Dist.CLIENT)
public class WolfArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public WolfArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.texOffs(0, 0).addBox(-5.0F, -34.0F + 24.0F - testificateHelmetShiftUp, -4.0F - 1.0F, 10.0F, 10.0F, 10.0F, 0.0F, false);
		Head.texOffs(0, 0).addBox(2.0F, -37.0F + 24.0F - testificateHelmetShiftUp, 1.0F - 1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
		Head.texOffs(0, 0).addBox(-5.0F, -37.0F + 24.0F - testificateHelmetShiftUp, 1.0F - 1.0F, 3.0F, 3.0F, 2.0F, 0.0F, false);
		Head.texOffs(48, 32).addBox(-2.0F, -31.0F + 24.0F - testificateHelmetShiftUp, -8.0F - 1.0F, 4.0F, 3.0F, 4.0F, 0.0F, false);
		...
		LeftArm.texOffs(48, 20).addBox(-9.0F + 8.0F, -24.0F + 22.0F, -2.0F, 4.0F, 5.0F, 4.0F, 1.0F, true);

		RightArm = new ModelRenderer(this);
		RightArm.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.texOffs(48, 20).addBox(5.0F - 8.0F, -24.0F + 22.0F, -2.0F, 4.0F, 5.0F, 4.0F, 1.0F, false);
	}
