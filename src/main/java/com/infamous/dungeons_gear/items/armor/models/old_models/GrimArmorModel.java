...
public class GrimArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public GrimArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Everything.setPos(7.0F, 12.0F, -2.0F);
