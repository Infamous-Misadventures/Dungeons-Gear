...
@OnlyIn(Dist.CLIENT)
public class CuriousArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public CuriousArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		LeftArm.texOffs(0, 32).addBox(4.0F-5.0F, -24.0F +22.0F, -2.0F, 4.0F, 6.0F, 4.0F, 1.0F, false);
		LeftArm.texOffs(32, 32).addBox(5.0F-5.0F, -19.0F +23.0F, -2.0F, 3.0F, 4.0F, 4.0F, 0.5F, true);

		RightArm = new ModelRenderer(this);
		RightArm.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.texOffs(0, 32).addBox(-8.0F+5.0F, -24.0F +22.0F, -2.0F, 4.0F, 6.0F, 4.0F, 1.0F, true);
		RightArm.texOffs(16, 32).addBox(-8.0F+5.0F, -19.0F +23.0F, -2.0F, 3.0F, 4.0F, 4.0F, 0.5F, true);
