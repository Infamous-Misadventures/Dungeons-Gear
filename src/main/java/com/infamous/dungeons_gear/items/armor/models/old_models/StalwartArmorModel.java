...
public class StalwartArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public StalwartArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Chestplate.texOffs(0, 36).addBox(0.7F, -7.7467F + 24.0F, -3.5992F, 5.0F, 4.0F, 2.0F, 0.3F, false);
		Chestplate.texOffs(0, 36).addBox(-5.7F, -7.7467F + 24.0F, -3.5992F, 5.0F, 4.0F, 2.0F, 0.3F, true);

		LeftArm = new ModelRenderer(this);
		LeftArm.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.texOffs(0, 29).addBox(5.0F-8.0F + 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, false);
		LeftArm.texOffs(0, 23).addBox(7.0F-8.0F + 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.5F, true);
		...
		RightArm.texOffs(0, 29).addBox(-9.0F + 8.0F - 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, true);
		RightArm.texOffs(0, 16).addBox(-9.0F + 8.0F - 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, false);
		RightArm.texOffs(0, 23).addBox(-9.0F + 8.0F - 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.5F, false);
	}
