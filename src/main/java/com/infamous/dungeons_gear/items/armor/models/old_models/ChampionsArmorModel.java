...
public class ChampionsArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public ChampionsArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Wings.setPos(0.0F, -7.0F, 17.0F);
		Head.addChild(Wings);
		setRotationAngle(Wings, 0.6545F, 0.0F, 0.0F);
		Wings.texOffs(27, 16).addBox(-5.2F, -31.0F + 19.0F - testificateHelmetShiftUp, -2.0F - 13.0F, 0.0F, 3.0F, 8.0F, 0.0F, false);
		Wings.texOffs(27, 16).addBox(5.2F, -31.0F + 19.0F - testificateHelmetShiftUp, -2.0F - 13.0F, 0.0F, 3.0F, 8.0F, 0.0F, false);
		...
		Chestplate.texOffs(46, 23).addBox(0.7F, -7.7467F + 24.0F, -4.0F, 5.0F, 4.0F, 2.0F, 0.3F, false);
		Chestplate.texOffs(46, 23).addBox(-5.7F, -7.7467F + 24.0F, -4.0F, 5.0F, 4.0F, 2.0F, 0.3F, true);

		LeftArm = new ModelRenderer(this);
		LeftArm.setPos(-5.0F, 35.0F, -15.0F);
		Everything.addChild(LeftArm);
		LeftArm.texOffs(48, 16).addBox(5.0F-8.0F + 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, false);
		LeftArm.texOffs(32, 16).addBox(4.0F-8.0F + 2.0F, -22.0F + 22.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.5F, false);
		LeftArm.texOffs(0, 16).addBox(8.0F-8.0F + 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, true);
		LeftArm.texOffs(10, 16).addBox(7.0F-8.0F + 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.5F, true);

		RightArm = new ModelRenderer(this);
		RightArm.setPos(-5.0F, 35.0F, -15.0F);
		Everything.addChild(RightArm);
		RightArm.texOffs(48, 16).addBox(-9.0F + 8.0F - 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, true);
		RightArm.texOffs(32, 16).addBox(-8.0F + 8.0F - 2.0F, -22.0F + 22.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.5F, true);
		RightArm.texOffs(0, 16).addBox(-9.0F + 8.0F - 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, false);
		RightArm.texOffs(10, 16).addBox(-9.0F + 8.0F - 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.5F, false);
	}
