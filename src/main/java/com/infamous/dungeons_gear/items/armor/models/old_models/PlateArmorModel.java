...
public class PlateArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public PlateArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Body.texOffs(40, 16).addBox(-4.0F, -13.0F + 24.0F, -2.0F, 8.0F, 3.0F, 4.0F, 1.1F, false);
		...
		Chestplate.texOffs(0, 51).addBox(-5.0F, -8.0F + 21.0F, -5.0F-9.0F, 10.0F, 8.0F, 3.0F, 0.7F, false);
		Chestplate.texOffs(23, 52).addBox(-3.0F, -8.9367F + 21.0F, -4.6498F-9.0F, 6.0F, 8.0F, 3.0F, 0.5F, false);

		LeftArm = new ModelRenderer(this);
		LeftArm.setPos(-6.0F, 11.0F, 2.0F);
		Everything.addChild(LeftArm);
		LeftArm.texOffs(0, 16).addBox(5.0F-8.0F + 2.0F, -27.0F + 22.0F, -2.0F, 1.0F, 2.0F, 4.0F, 1.0F, true);
		LeftArm.texOffs(0, 32).addBox(5.0F-8.0F + 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 4.0F, 4.0F, 1.0F, false);
		LeftArm.texOffs(0, 16).addBox(8.0F-8.0F + 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, true);
		LeftArm.texOffs(0, 26).addBox(7.0F-8.0F + 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.2F, true);

		RightArm = new ModelRenderer(this);
		RightArm.setPos(-6.0F, 11.0F, 2.0F);
		Everything.addChild(RightArm);
		RightArm.texOffs(0, 16).addBox(-6.0F + 8.0F - 2.0F, -27.0F + 22.0F, -2.0F, 1.0F, 2.0F, 4.0F, 1.0F, false);
		RightArm.texOffs(0, 32).addBox(-9.0F + 8.0F - 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 4.0F, 4.0F, 1.0F, true);
		RightArm.texOffs(0, 16).addBox(-9.0F + 8.0F - 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, false);
		RightArm.texOffs(0, 26).addBox(-9.0F + 8.0F - 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.2F, false);
	}
