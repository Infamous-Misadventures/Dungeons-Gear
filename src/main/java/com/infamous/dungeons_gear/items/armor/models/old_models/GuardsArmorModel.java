...
public class GuardsArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public GuardsArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(Head);
		Head.setTextureOffset(0, 0).addBox(-4.0F, -26.0F+18.0F - testificateHelmetShiftUp, -4.0F, 8.0F, 8.0F, 8.0F, 1.0F, false);
		Head.setTextureOffset(0, 0).addBox(-1.0F, -27.0F+18.0F - 0.125F + 0.1F - testificateHelmetShiftUp, 3.7F + 1.25F + 0.1F, 2.0F, 6.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		Head.setTextureOffset(0, 0).addBox(-1.0F, -27.0F+18.0F - 0.125F + 0.1F - testificateHelmetShiftUp, -4.7F - 1.25F - 0.1F, 2.0F, 6.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		Head.setTextureOffset(33, 1).addBox(-1.0F, -27.0F+18.0F - 1.0F - 0.01F - testificateHelmetShiftUp, -4.3F, 2.0F, 1.0F, 9.0F, 0.0F, 0.0F, 1.0F);

		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(Body);
		Body.setTextureOffset(16, 16).addBox(-4.0F, -18.0F+18.0F, -2.0F, 8.0F, 12.0F, 4.0F,  1.0F, 1.0F, 1.0F);

		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.setTextureOffset(0, 32).addBox(4.0F-5.0F, -18.0F+16.0F, -2.0F, 4.0F, 6.0F, 4.0F, 1.0F, false);

		RightArm = new ModelRenderer(this);
		RightArm.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.setTextureOffset(0, 32).addBox(-8.0F+5.0F, -18.0F+16.0F, -2.0F, 4.0F, 6.0F, 4.0F, 1.0F, true);
		RightArm.setTextureOffset(16, 32).addBox(-8.0F+5.0F, -12.0F+16.0F, -2.0F, 3.0F, 2.0F, 4.0F, 0.5F, 0.5F, 0.5F);
	}
