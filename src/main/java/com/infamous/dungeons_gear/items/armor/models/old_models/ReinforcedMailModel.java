...
@OnlyIn(Dist.CLIENT)
public class ReinforcedMailModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public ReinforcedMailModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
