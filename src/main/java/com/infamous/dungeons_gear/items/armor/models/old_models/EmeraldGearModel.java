...
@OnlyIn(Dist.CLIENT)
public class EmeraldGearModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public EmeraldGearModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
