...
public class RenegadeArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public RenegadeArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.texOffs(32, 16).addBox(-4.0F, -32.0F + 24.0F - testificateHelmetShiftUp, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		...
		Chestplate.texOffs(0, 36).addBox(-4.0F, -8.0F + 22.0F, -5.0F - 11.0F, 8.0F, 8.0F, 3.0F, 0.999F, 1.0F, 1.0F);


		LeftArm = new ModelRenderer(this);
		LeftArm.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.texOffs(0, 29).addBox(5.0F-5.0F, -24.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, false);
		LeftArm.texOffs(16, 29).addBox(4.0F-5.0F, -18.0F + 22.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.5F, false);
		LeftArm.texOffs(0, 23).addBox(7.0F-5.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.5F, true);
		...
		RightArm.texOffs(16, 29).addBox(-8.0F+5.0F, -18.0F + 22.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.5F, true);
		RightArm.texOffs(0, 29).addBox(-9.0F+5.0F, -24.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, true);
		RightArm.texOffs(0, 16).addBox(-9.0F+5.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, false);
		RightArm.texOffs(0, 23).addBox(-9.0F+5.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.5F, false);
	}
