...
public class FrostArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public FrostArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.texOffs(0, 52).addBox(-1.0F, -35.0F + 24.0F - testificateHelmetShiftUp, -5.0F, 2.0F, 2.0F, 10.0F, 0.0F, false);
		Head.texOffs(24, 62).addBox(-5.0F, -34.0F + 24.0F - testificateHelmetShiftUp, -5.0F, 10.0F, 1.0F, 1.0F, 0.0F, false);

		Body = new ModelRenderer(this);
		Body.setPos(0.0F, 24.0F, 0.0F);
		Everything.addChild(Body);
		Body.texOffs(16, 16).addBox(-4.0F, -24.0F + 24.0F, -2.0F, 8.0F, 12.0F, 4.0F, 1.0F, false);

		Chestplate = new ModelRenderer(this);
		Chestplate.setPos(0.0F, -15.0F, 0.0F);
		Body.addChild(Chestplate);
		Chestplate.texOffs(32, 7).addBox(-4.0F, -7.7467F + 24.0F, -4.0F, 8.0F, 4.0F, 1.0F, 0.0F, true);

		RightArm = new ModelRenderer(this);
		RightArm.setPos(0.0F, 24.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.texOffs(0, 23).addBox(-9.0F + 8.0F - 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 5.0F, 4.0F, 1.0F, true);
		RightArm.texOffs(24, 36).addBox(-9.0F + 8.0F - 2.0F, -27.0F + 22.0F, -0.1F, 4.0F, 5.0F, 2.0F, 1.0F, true);
		RightArm.texOffs(0, 41).addBox(-9.0F + 8.0F - 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.2F, false);
		RightArm.texOffs(0, 41).addBox(-9.0F + 8.0F - 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, false);

		LeftArm = new ModelRenderer(this);
		LeftArm.setPos(0.0F, 24.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.texOffs(0, 32).addBox(5.0F-8.0F + 2.0F, -24.0F + 22.0F, -2.0F, 4.0F, 5.0F, 4.0F, 1.0F, false);
		LeftArm.texOffs(22, 35).addBox(5.0F-8.0F + 2.0F, -27.0F + 22.0F, -1.1F, 4.0F, 5.0F, 3.0F, 1.0F, false);
		LeftArm.texOffs(0, 41).addBox(7.0F-8.0F + 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.2F, true);
		LeftArm.texOffs(0, 41).addBox(8.0F-8.0F + 2.0F, -15.0F + 22.0F, -2.0F, 1.0F, 3.0F, 4.0F, 0.5F, true);
	}
