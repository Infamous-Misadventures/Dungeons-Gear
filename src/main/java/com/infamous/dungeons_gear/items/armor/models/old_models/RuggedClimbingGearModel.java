...
public class RuggedClimbingGearModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public RuggedClimbingGearModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.texOffs(10, 23).addBox(-4.5F, -7.75F - testificateHelmetShiftUp, -4.27F, 9.0F, 10.0F, 0.0F, 0.0F, false);
		...
		RightArmArmor_r1.texOffs(42, 2).addBox(-3.0F, -0.75F, -2.5F, 6.0F, 3.0F, 4.0F, 0.75F, false);
		...
		RightArmArmor_r2.texOffs(42, 48).addBox(-3.0F, 2.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.5F, false);
		...
		RightArmArmor_r3.texOffs(42, 11).addBox(-3.0F, -2.0F, -2.0F, 6.0F, 12.0F, 4.0F, 0.25F, true);
		...
		LeftArmArmor_r1.texOffs(42, 2).addBox(-3.0F, -0.25F, -2.75F, 6.0F, 3.0F, 4.0F, 0.75F, false);
		...
		LeftArmArmor_r2.texOffs(42, 48).addBox(-3.0F, 3.0F, -2.0F, 6.0F, 2.0F, 4.0F, 0.5F, true);
		...
		LeftArmArmor_r3.texOffs(42, 11).addBox(-3.0F, -2.0F, -2.0F, 6.0F, 12.0F, 4.0F, 0.25F, false);
	}
