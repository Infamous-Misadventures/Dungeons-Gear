package com.infamous.dungeons_gear.items.armor.models.old_models;
...
public class OcelotArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public OcelotArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.texOffs(0, 0).addBox(-4.0F - 1.0F, -34.0F + 24.0F - testificateHelmetShiftUp, -4.0F - 1.0F, 10.0F, 10.0F, 10.0F, 0.0F, false);
		Head.texOffs(51, 30).addBox(3.0F - 1.0F, -36.0F + 24.0F - testificateHelmetShiftUp, 1.0F - 1.0F, 2.0F, 2.0F, 3.0F, 0.0F, true);
		Head.texOffs(51, 30).addBox(-3.0F - 1.0F, -36.0F + 24.0F - testificateHelmetShiftUp, 1.0F - 1.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		Head.texOffs(48, 57).addBox(-0.5F - 1.0F, -32.0F + 24.0F - testificateHelmetShiftUp, -6.0F - 1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);

		Body = new ModelRenderer(this);
		Body.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(Body);
		Body.texOffs(40, 0).addBox(-4.0F, -24.0F + 24.0F, -2.0F, 8.0F, 10.0F, 4.0F, 1.0F, false);
		Body.texOffs(40, 19).addBox(-4.0F, -14.0F + 24.0F, -2.0F, 8.0F, 3.0F, 4.0F, 0.6F, false);

		LeftArm = new ModelRenderer(this);
		LeftArm.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.texOffs(48, 38).addBox(-9.0F + 8.0F, -24.0F + 22.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.4F, true);
		LeftArm.texOffs(48, 52).addBox(-9.0F + 8.0F, -13.0F + 22.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.2F, false);

		RightArm = new ModelRenderer(this);
		RightArm.setPos(0.0F, 0.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.texOffs(48, 38).addBox(5.0F - 8.0F, -24.0F + 22.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.5F, false);
		RightArm.texOffs(48, 52).addBox(5.0F - 8.0F, -13.0F + 22.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.2F, true);
	}
