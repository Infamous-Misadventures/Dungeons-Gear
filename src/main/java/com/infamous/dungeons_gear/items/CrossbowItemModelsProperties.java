...
public class CrossbowItemModelsProperties {
	...
	public CrossbowItemModelsProperties() {
		...
		/*
		// BURST CROSSBOW
		ItemModelsProperties.registerProperty(BURST_CROSSBOW, new ResourceLocation("pull"),
				(p_239427_0_, p_239427_1_, p_239427_2_) -> {
					if (p_239427_2_ == null) {
						return 0.0F;
					} else {
		...
		ItemModelsProperties.registerProperty(BURST_CROSSBOW, new ResourceLocation("pulling"),
				(p_239426_0_, p_239426_1_, p_239426_2_) -> {
					return p_239426_2_ != null && p_239426_2_.isHandActive()
		...
		ItemModelsProperties.registerProperty(BURST_CROSSBOW, new ResourceLocation("charged"),
				(p_239425_0_, p_239425_1_, p_239425_2_) -> {
					return p_239425_2_ != null && BurstCrossbowItem.isCharged(p_239425_0_) ? 1.0F : 0.0F;
				});

		// SOUL HUNTER CROSSBOW
		ItemModelsProperties.registerProperty(SOUL_HUNTER_CROSSBOW, new ResourceLocation("pull"),
				(p_239427_0_, p_239427_1_, p_239427_2_) -> {
					if (p_239427_2_ == null) {
						return 0.0F;
					} else {
		...
		ItemModelsProperties.registerProperty(SOUL_HUNTER_CROSSBOW, new ResourceLocation("pulling"),
				(p_239426_0_, p_239426_1_, p_239426_2_) -> {
					return p_239426_2_ != null && p_239426_2_.isHandActive()
							&& p_239426_2_.getActiveItemStack() == p_239426_0_ && !BurstCrossbowItem.isCharged(p_239426_0_)
							? 1.0F
		...
		ItemModelsProperties.registerProperty(SOUL_HUNTER_CROSSBOW, new ResourceLocation("charged"),
				(p_239425_0_, p_239425_1_, p_239425_2_) -> {
					return p_239425_2_ != null && BurstCrossbowItem.isCharged(p_239425_0_) ? 1.0F : 0.0F;
				});
		// CORRUPTED CROSSBOW
		ItemModelsProperties.registerProperty(CORRUPTED_CROSSBOW, new ResourceLocation("pull"),
				(p_239427_0_, p_239427_1_, p_239427_2_) -> {
					if (p_239427_2_ == null) {
						return 0.0F;
					} else {
		...
		ItemModelsProperties.registerProperty(CORRUPTED_CROSSBOW, new ResourceLocation("pulling"),
				(p_239426_0_, p_239426_1_, p_239426_2_) -> {
					return p_239426_2_ != null && p_239426_2_.isHandActive()
							&& p_239426_2_.getActiveItemStack() == p_239426_0_ && !BurstCrossbowItem.isCharged(p_239426_0_)
							? 1.0F
		...
		ItemModelsProperties.registerProperty(CORRUPTED_CROSSBOW, new ResourceLocation("charged"),
				(p_239425_0_, p_239425_1_, p_239425_2_) -> {
					return p_239425_2_ != null && BurstCrossbowItem.isCharged(p_239425_0_) ? 1.0F : 0.0F;
				});
