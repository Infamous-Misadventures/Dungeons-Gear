...
public class ArtifactEvents {
    ...
    private static void preventAttackForSummonableMob(LivingEntity summonableAttacker) {
        ...
        if (summonableAttacker instanceof BeeEntity) {
            ...
            beeEntity.setAttackTarget(null);
            beeEntity.setRevengeTarget(null);
        }
        if (summonableAttacker instanceof SheepEntity) {
            SheepEntity sheepEntity = (SheepEntity) summonableAttacker;
            sheepEntity.setAttackTarget(null);
            sheepEntity.setRevengeTarget(null);
        }
    }
