...
public class SoulScytheItem extends SwordItem implements IMeleeWeapon, ISoulGatherer {
    ...
    public float getDestroySpeed(ItemStack p_150893_1_, BlockState p_150893_2_) {
        if (p_150893_2_.getBlock() instanceof WebBlock || p_150893_2_.isIn(BlockTags.LEAVES)) {
            return 15.0F;
        } else {
    ...
    public boolean canHarvestBlock(BlockState p_150897_1_) {
        return p_150897_1_.getBlock() instanceof WebBlock || p_150897_1_.isIn(BlockTags.LEAVES);
    }
