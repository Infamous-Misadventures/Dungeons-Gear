        ...
        if(event.getSource().getTrueSource() instanceof LivingEntity){
            ...
            if ((attacker.getHeldItemMainhand().getItem()  instanceof ClaymoreItem)
                ...
                if(attacker instanceof PlayerEntity){
                    ...
                    victim.knockBack(attacker, attackKnockbackStrength * 0.5F, (double) MathHelper.sin(playerEntity.rotationYaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(playerEntity.rotationYaw * ((float)Math.PI / 180F))));
                    ...
                    if (attackKnockbackStrength > 0.0F) {
                        victim.knockBack(attacker, attackKnockbackStrength * 0.5F, (double)MathHelper.sin(mobEntity.rotationYaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(mobEntity.rotationYaw * ((float)Math.PI / 180F))));
