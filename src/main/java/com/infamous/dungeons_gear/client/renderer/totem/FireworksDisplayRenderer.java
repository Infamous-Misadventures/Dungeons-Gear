...
public class FireworksDisplayRenderer extends GeoProjectilesRenderer<FireworksDisplayEntity> {
	public FireworksDisplayRenderer(EntityRendererManager renderManager) {
		super(renderManager, new FireworksDisplayModel());
	}
	

	@Override
	public RenderType getRenderType(FireworksDisplayEntity animatable, float partialTicks, MatrixStack stack,
