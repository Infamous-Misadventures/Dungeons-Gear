...
public class TotemOfShieldingRenderer extends GeoProjectilesRenderer<TotemOfShieldingEntity> {
	public TotemOfShieldingRenderer(EntityRendererManager renderManager) {
		super(renderManager, new TotemOfShieldingModel());
	}
	

	@Override
	public RenderType getRenderType(TotemOfShieldingEntity animatable, float partialTicks, MatrixStack stack,
