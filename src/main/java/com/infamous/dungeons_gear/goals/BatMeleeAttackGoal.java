...
public class BatMeleeAttackGoal extends Goal {
    protected final BatEntity attacker;
    ...
    public BatMeleeAttackGoal(BatEntity mobEntity, double speedIn, boolean useLongMemory) {
    ...
    protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
        ...
        if (distToEnemySqr <= d0 && this.field_234037_i_ <= 0) {
            ...
            if (this.attacker instanceof BatEntity) {
                enemy.attackEntityFrom(DamageSource.causeMobDamage(this.attacker), 1.0F);
            } else {
