...
public class ArtifactBeamEntity extends Entity implements IEntityAdditionalSpawnData {
    ...
    public ArtifactBeamEntity(EntityType<?> p_i48580_1_, World p_i48580_2_) {
        super(p_i48580_1_, p_i48580_2_);
    }


    public ArtifactBeamEntity(EntityType<?> p_i48580_1_, BeamColor beamColor, World p_i48580_2_, LivingEntity owner) {
        super(p_i48580_1_, p_i48580_2_);
        this.setOwner(owner);
    ...
    public void tick() {
        ...
        if(!this.level.isClientSide) {
            ...
            IArtifactUsage artifactUsage = ArtifactUsageHelper.getArtifactUsageCapability(owner);
            if(artifactUsage != null && (!artifactUsage.isUsingArtifact() || !(artifactUsage.getUsingArtifact().getItem() instanceof AbstractBeaconItem) )){
                this.remove();
                return;
            }
        }
