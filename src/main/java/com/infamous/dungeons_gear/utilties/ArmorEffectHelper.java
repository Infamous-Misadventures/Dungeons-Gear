    ...
    public static void teleportOnHit(LivingEntity livingEntity) {
        ...
        if (!world.isClientSide) {
            ...
            for (int i = 0; i < 16; ++i) {
                ...
                double teleportY = Mth.clamp(livingEntity.getY() + (double) (livingEntity.getRandom().nextInt(16) - 8), 0.0D, world.getHeight() - 1);
                ...
                if (livingEntity.randomTeleport(teleportX, teleportY, teleportZ, true)) {
                    ...
                    world.playSound(null, livingEntity.blockPosition(), soundEvent, SoundSource.PLAYERS, 1.0F, 1.0F);
