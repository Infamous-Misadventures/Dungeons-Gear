...
public class ArchersArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public ArchersArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.setRotationPoint(0.0F, -24.0F + 24.0F, 0.0F);
		...
		BackHead.setRotationPoint(4.0F, -6.0F, 4.0F);
		Head.addChild(BackHead);
		setRotationAngle(BackHead, -0.3491F, 0.0F, 0.0F);
		BackHead.setTextureOffset(40, 16).addBox(-8.0F, -2.0F - testificateHelmetShiftUp, 0.0F, 8.0F, 2.0F, 2.0F, 0.9F, false);
		...
		LeftArm.setTextureOffset(0, 16).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, false);

		RightArm = new ModelRenderer(this);
		RightArm.setRotationPoint(-5.0F, -22.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.setTextureOffset(0, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, true);
	}
