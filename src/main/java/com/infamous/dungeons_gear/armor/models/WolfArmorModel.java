...
public class WolfArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public WolfArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		LeftArm.setTextureOffset(48, 20).addBox(-9.0F + 8.0F, -24.0F + 22.0F, -2.0F, 4.0F, 5.0F, 4.0F, 1.0F, true);

		RightArm = new ModelRenderer(this);
		RightArm.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.setTextureOffset(48, 20).addBox(5.0F - 8.0F, -24.0F + 22.0F, -2.0F, 4.0F, 5.0F, 4.0F, 1.0F, false);
	}
