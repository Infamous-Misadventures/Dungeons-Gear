...
public class SnowArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public SnowArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		Head.setTextureOffset(0, 0).addBox(-4.0F, -8.0F - testificateHelmetShiftUp, -4.0F, 8.0F, 8.0F, 8.0F, 1.0F, false);
		Head.setTextureOffset(0, 52).addBox(1.4F, -10.0F - testificateHelmetShiftUp, -5.0F, 1.0F, 1.0F, 10.0F, 0.1F, false);
		Head.setTextureOffset(0, 52).addBox(-2.4F, -10.0F - testificateHelmetShiftUp, -5.0F, 1.0F, 1.0F, 10.0F, 0.1F, false);
		Head.setTextureOffset(0, 0).addBox(5.0F, -11.0F - testificateHelmetShiftUp, -5.0F, 1.0F, 3.0F, 2.0F, 0.0F, false);
		Head.setTextureOffset(0, 0).addBox(-6.0F, -11.0F - testificateHelmetShiftUp, -5.0F, 1.0F, 3.0F, 2.0F, 0.0F, true);

		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, -24.0F, 0.0F);
		Everything.addChild(Body);
		Body.setTextureOffset(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 1.0F, false);
		Body.setTextureOffset(32, 7).addBox(-4.0F, 1.0F, -4.0F, 8.0F, 4.0F, 1.0F, 0.0F, false);

		RightArm = new ModelRenderer(this);
		RightArm.setRotationPoint(-5.0F, -22.0F, 0.0F);
		Everything.addChild(RightArm);
		RightArm.setTextureOffset(0, 32).addBox(-5.0F + 2.0F, -2.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, false);
		RightArm.setTextureOffset(0, 39).addBox(-6.0F  + 2.0F, 8.0F, -2.0F, 2.0F, 3.0F, 4.0F, 1.0F, false);
		RightArm.setTextureOffset(12, 39).addBox(-5.0F  + 2.0F, 9.0F, -2.0F, 2.0F, 3.0F, 4.0F, 0.5F, false);

		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(5.0F, -22.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.setTextureOffset(0, 23).addBox(1.0F  - 2.0F, -2.0F, -2.0F, 4.0F, 3.0F, 4.0F, 1.0F, false);
		LeftArm.setTextureOffset(0, 39).addBox(4.0F  - 2.0F, 8.0F, -2.0F, 2.0F, 3.0F, 4.0F, 1.0F, true);
		LeftArm.setTextureOffset(12, 39).addBox(3.0F  - 2.0F, 9.0F, -2.0F, 2.0F, 3.0F, 4.0F, 0.5F, false);
	}
