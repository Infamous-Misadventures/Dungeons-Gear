...
public class BattleRobeModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public BattleRobeModel(float modelSize, EquipmentSlotType slot, LivingEntity entity) {
		...
		LeftArm.setTextureOffset(42, 26).addBox(-1.0F, -3.0F, -3.0F, 5.0F, 3.0F, 6.0F, 1.0F, 1.0F, 1.0F);
		...
		RightArm.setTextureOffset(36, 16).addBox(-4.0F, -3.0F, -3.0F, 5.0F, 3.0F, 6.0F, 1.0F, 1.0F, 1.0F);
