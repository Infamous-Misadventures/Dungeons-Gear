...
public class PhantomArmorModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public PhantomArmorModel(float modelSize, EquipmentSlotType slot, LivingEntity entity, boolean unique) {
		...
		Head.setTextureOffset(0, 42).addBox(-4.0F, -35.0F +24.0F - testificateHelmetShiftUp, -4.0F, 8.0F, 1.0F, 8.0F, 1.0F, false);

		Body = new ModelRenderer(this);
		Body.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(Body);
		Body.setTextureOffset(40, 0).addBox(-4.0F, -24.0F +24.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.9F, false);

		ChinGuard = new ModelRenderer(this);
		ChinGuard.setRotationPoint(0.0F, -15.0F, 0.0F);
		Head.addChild(ChinGuard);
		ChinGuard.setTextureOffset(0, 36).addBox(-4.0F, -7.7467F +24.0F, -5.0F, 8.0F, 2.0F, 2.0F, 0.0F, true);

		LeftArm = new ModelRenderer(this);
		LeftArm.setRotationPoint(0.0F, 0.0F, 0.0F);
		Everything.addChild(LeftArm);
		LeftArm.setTextureOffset(0, 29).addBox(6.0F -8.0F + 2.0F, -25.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 0.8F, false);
		LeftArm.setTextureOffset(0, 51).addBox(5.2F -8.0F + 2.0F, -21.0F + 22.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.2F, false);
		LeftArm.setTextureOffset(16, 29).addBox(5.2F -8.0F + 2.0F, -26.8F + 22.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, false);
		LeftArm.setTextureOffset(0, 23).addBox(7.0F -8.0F + 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.4F, true);
		...
		RightArm.setTextureOffset(0, 29).addBox(-10.0F +8.0F - 2.0F, -25.0F + 22.0F, -2.0F, 4.0F, 3.0F, 4.0F, 0.8F, true);
		RightArm.setTextureOffset(0, 51).addBox(-9.2F +8.0F - 2.0F, -21.0F + 22.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.2F, true);
		RightArm.setTextureOffset(16, 29).addBox(-9.2F +8.0F - 2.0F, -26.8F + 22.0F, -2.0F, 4.0F, 1.0F, 4.0F, 0.0F, true);
		RightArm.setTextureOffset(0, 23).addBox(-9.0F +8.0F - 2.0F, -12.0F + 22.0F, -2.0F, 2.0F, 1.0F, 4.0F, 0.4F, false);
